...
class MetadataWriter():
    ...
    def writeMetadataFile(self, metadataFile):
        ...
        rootElement = ET.Element("Metadata", {"type": self.metadataType, "metadata_version": self.metadataVersion,
                                              "script_version": self.scriptVersion})
        ...
        for run in self.Runs:
            ...
            ET.SubElement(nodeRun, "TotalProcessingTime").text = str(
                run.timeProcessing.total_seconds())  # Need to provide attribute for unit of time
